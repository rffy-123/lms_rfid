...
def search():
	...
	if len(d) >0:
		return render_template("books.html", search=True, books=d, count=len(d), keyword=(keyword), g=g)

	return render_template('books.html', error="No books found!", keyword=(keyword))
